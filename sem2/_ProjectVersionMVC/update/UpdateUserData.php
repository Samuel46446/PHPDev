...
<head>
    ...
    <title>Modding Minecraft - Mise à jour du profil</title>
...
{ ?>
<h1 class="h1Tuto">Modding Minecraft : Mise à jour du profil utilisateur</h1>

<form action="UpdateUserData.php" method="POST">
    <?php
    if (isset($_SESSION['sendingUserChanges'])) {
        if ($_SESSION['sendingUserChanges']) {
            echo "<p class=\"pCopyright\">✅ Vous avez modifié votre profil, vous êtes à présent déconnecter.</p>";
            ...
            echo "<a href=\"UpdateUserData.php\" title=\"Lien pour réessayer de mettre à jour le profil utilisateur\">Réessayer</a>";
        }
    } else {
        ?>
