...
<h1 class="h1Tuto">Modding Minecraft : Créer un tutoriel</h1>
    ...
    if (isset($_SESSION['sendingTutorial'])) {
        if ($_SESSION['sendingTutorial']) {
            ...
            echo "<div class=\"home\"><a href=\"CreateComponent.php\" class=\"button-link\"><img src=\"../../textures/components.png\" alt=\"Lien pour créer un autre tutoriel\" width=\"50\" height=\"50\"></a></div>";
        } else if ($_GET['sendingTutorial'] === false) {
            echo "<p class=\"pCopyright\">❌ Le tutoriel n'a pas pu être créé, veuillez réessayer.</p>";
            echo "<a href=\"CreateTutorial.php\" title=\"Lien pour réessayer de créer ce tutoriel\">Réessayer</a>";
        }
    } else {
        ?>
