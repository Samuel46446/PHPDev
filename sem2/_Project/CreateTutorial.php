...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    !empty($_POST["about"]) && !empty($_POST["description"]) && !empty($_POST["finaldesc"]))) {
        ...
        $_SESSION['titleTutorial'] = lcfirst($title);
...
<form action="CreateTutorial.php" method="POST">
    ...
    if (isset($_SESSION['sendingTutorial'])) {
        if ($_SESSION['sendingTutorial']) {
            ...
            echo "<div class=\"home\"><a href=\"CreateComponent.php?tutoCno=" . $_SESSION['titleTutorial'] . "\" class=\"button-link\"><img src=\"textures/components.png\" alt=\"Home\" width=\"50\" height=\"50\"></a></div>";
        ...
        <button type="submit">Créer le tutoriel</button>
        <?php
    }
    ?>
</form>
