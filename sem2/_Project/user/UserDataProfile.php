...
<body>
    ...
    { ?>
    <h1 class="h1TutoCenter">Forum - Modding Minecraft : Profile de <?php echo $_SESSION['username']; ?></h1>
    ...
    <form>
        ...
        <label>
            <a class="deleteButton" href="../drop/DeleteUserData.php">Supprimer le compte</a>
        </label>
    </form>
    <?php
    }
