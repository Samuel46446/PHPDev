...
use sem2\_Project\registries\DroppingRegistry;
...
<form action="DeleteReponse.php?pno=<?php echo $_GET['pno']; ?>&rno=<?php echo $_GET['rno']; ?>" method="POST">
    ...
    if (isset($_SESSION['sendingPostDrop'])) {
        if ($_SESSION['sendingPostDrop']) {
            ...
            echo "<div class=\"home\"><a href=\"../../controllers/Posts.php?pno=".$_GET['pno']."\" class=\"button-link\"><img src=\"../../textures/message.png\" alt=\"Lien pour retourner sur le post\" width=\"50\" height=\"50\"></a></div>";
            ...
            echo "<a href=\"../../controllers/Posts.php?pno=".$_GET['pno']."\" title=\"Lien pour retourner sur le post sans supprimer la réponse\">Annuler</a>";
        }
    } else {
        ?>
