...
<h1 class="h1Tuto">Modding Minecraft : Delete Tutorial</h1>
    ...
    if (isset($_SESSION['sendingComponent'])) {
        if ($_SESSION['sendingComponent']) {
            ...
            echo "<div class=\"home\"><a href=\"DeleteTutorial.php\" class=\"button-link\"><img src=\"../../textures/retry.png\" alt=\"Lien pour supprimer un autre tutoriel\" width=\"50\" height=\"50\"></a></div>";
            ...
            echo "<a href=\"DeleteTutorial.php\" title=\"Lien pour réessayer de supprimer le tutoriel\">Réessayer</a>";
        }
    } else {
        ?>
        <label>
