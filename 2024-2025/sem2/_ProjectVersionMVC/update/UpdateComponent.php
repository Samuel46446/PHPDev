...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    //var_dump($_POST); // 🔍 Affichage explicite avant tout traitement.
...
<head>
    ...
    <title>Modding Minecraft - Mise à jour d'un Composant</title>
...
if (isset($_SESSION['user_id'], $_SESSION['username']))
{
    ...
    {
        ?>
<h1 class="h1Tuto">Modding Minecraft : Mise à jour de composant</h1>
    ...
    if (isset($_SESSION['sendingComponent'])) {
        if ($_SESSION['sendingComponent']) {
            echo "<p class=\"pCopyright\">✅ Vous avez modifié le composant.</p>";
            ...
            echo "<div class=\"home\"><a href=\"UpdateComponent.php\" class=\"button-link\"><img src=\"../textures/retry.png\" alt=\"Lien pour mettre à jour un autre composant\" width=\"50\" height=\"50\"></a></div>";
            unset($_SESSION['sendingComponent']);
        } else if ($_SESSION['sendingComponent'] === false) {
            echo "<p class=\"pCopyright\">❌ Le composant n'a pas pu être modifié, veuillez réessayer.</p>";
            echo "<a href=\"UpdateComponent.php\" title=\"Lien pour réessayer de mettre à jour le composant\">Réessayer</a>";
        }
    } else {
        ?>
        <label>
