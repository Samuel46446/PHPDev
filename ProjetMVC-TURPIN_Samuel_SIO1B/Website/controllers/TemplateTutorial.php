...
require_once '../models/AttributeFetcher.php';
require_once '../models/RegistryEntry.php';
...
<head>
    ...
    <title>Modding Tutorial - Tutoriel : <?php echo $tabTuto['title']; ?></title>
...
<script>
    ...
    <header>
        ...
        <h1 class="h1VersionTuto"><?php echo "Version du Tutoriel : " . $tabTuto['version']; ?></h1>
    ...
    <footer>
        <p class="pCopyright" aria-hidden="true">&copy; 2025 Minecraft Modding Tutorial. All rights reserved.</p>
    </footer>
</body>
</html>