...
<form action="CreatePost.php" method="POST">
    ...
    if (isset($_SESSION['sendingPost'])) {
        if ($_SESSION['sendingPost']) {
            ...
            echo "<a href=\"CreatePost.php\" title=\"Lien pour réessayer de créer le post\">Réessayer</a>";
        }
    } else {
        ?>
        <?php echo "<div class=\"homeTuto\"><a href=\"../../controllers/Forum.php\" class=\"button-link\"><img src=\"../../textures/message.png\" alt=\"Lien vers le forum\" width=\"50\" height=\"50\"></a></div>"; ?>
